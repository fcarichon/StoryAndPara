...
class behavior():
    ...
    def behav_emoji(self, comments_list):
        ...
        avg_react = sum(behav_reac) / len(comments_list)
        nb_comment_reac = sum(reac_comment) / len(comments_list)

        return avg_react, nb_comment_reac
    ...
    def behav_slangs(self, comments_list):
        ...
        avg_reac = sum(behav_reac)/len(comments_list)
        return avg_reac
    ...
    def error_type(self, comments_list):
        ...
        avg_mistakes = sum(mistakes)/len(comments_list)
        avg_grammar = sum(grammar_list)/len(comments_list)

        return avg_mistakes, avg_grammar
    ...
    def take_time_to_write(self, comment_list, user_name, nb_words = 20, nb_charac=80):
        ...
        avg_take_time = sum(take_time) / len(comment_list)

        return avg_take_time
    ...
    def answer(self, comment_list, user_name):
        ...
        avg_answer = sum(answer_)/len(comment_list)
        return avg_answer
    ...
    def intent(self, comment_list):
        ...
        return sum(intent_)/len(comment_list)